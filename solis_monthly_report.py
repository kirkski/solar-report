...
CONFIG = {
    ...
    "api_key_id":     os.getenv("SOLIS_KEY_ID",     "1300386381676946611"),
    "api_key_secret": os.getenv("SOLIS_KEY_SECRET", "04320d6254e04358b0f457087aa6099a"),
    "smtp_server":    os.getenv("SMTP_SERVER",   "smtp.mail.me.com"),
    "smtp_port":      int(os.getenv("SMTP_PORT", "587")),
    "smtp_user":      os.getenv("SMTP_USER",     "kirkski@me.com"),
    "smtp_password":  os.getenv("SMTP_PASSWORD", "owlq-kgyl-kxzs-vcmd"),
    "email_to":       os.getenv("EMAIL_TO",      "kirkski@me.com"),
